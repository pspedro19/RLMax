  ...
  return (
    ...
    >
      ...
      <text
        ...
        className="font-mono"
      >
        {format(new Date(data[index].datetime), 'dd/MM')}
      </text>
    </motion.g>
  );
};
...
const InteractiveChart: React.FC<InteractiveChartProps> = ({
  ...
  const processedData = useMemo(() => {
    ...
    return data.map((item, index) => {
      ...
      const currentDay = format(new Date(item.datetime), 'yyyy-MM-dd');
